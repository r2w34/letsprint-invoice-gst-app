...
const EmailSetting = () => {
 ...
 const fetchSMTPConfiguration = async (shopId) => {
   try {
     ...
     const response = await window.authenticatedFetch(`/api/smtp/get?shopId=${shopId}`, {
       method: "GET",
       headers: { "Content-Type": "application/json" },
     });
 ...
 const fetchToggleSetting = async (shopId) => {
   try {
     ...
     const response = await window.authenticatedFetch(`/api/check-status?shopId=${shopId}`, {
       method: "GET",
       headers: { "Content-Type": "application/json" },
     });
 ...
 const updateToggleSetting = async (shopId, sendByOwnEmail) => {
   try {
     ...
     const response = await window.authenticatedFetch(`/api/change-send-by-own-email`, {
       method: "POST",
       headers: { "Content-Type": "application/json" },
       body: JSON.stringify({
         shopId,
 ...
 const updateToggleSettingbyApp = async (shopId, sendByAppEmail) => {
   try {
     ...
     const response = await window.authenticatedFetch(`/api/change-send-by-app-email`, {
       method: "POST",
       headers: { "Content-Type": "application/json" },
       body: JSON.stringify({
         shopId,
 ...
 const updateToggleSettingonOrderPlaced = async (shopId, sendOnOrderPlaced) => {
   try {
     ...
     const response = await window.authenticatedFetch(`/api/change-send-on-order-placed`, {
       method: "POST",
       headers: { "Content-Type": "application/json" },
       body: JSON.stringify({
         shopId,
...
let updatedSettings = smtpData
     const response = await window.authenticatedFetch("/api/smtp/update", {
       method: "PUT",
       headers: { "Content-Type": "application/json" },
       body: JSON.stringify({
         shopId,
