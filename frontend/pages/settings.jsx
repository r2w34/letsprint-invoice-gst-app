 ...
 export default function Settings() {
  ...
  const updateToggleSettingbyApp = async (shopId, taxChangeRequest) => {
    try {
      ...
      const response = await window.authenticatedFetch(`/api/update-tax-settings?storeDomain=${storeDomain}`, {
        method: "PUT",
  ...
  useEffect(() => {
    if(shopId){
    window.authenticatedFetch(`/api/fetch-store-profile?shopId=${shopId}`, {
      method: "GET",
      headers: { "Content-Type": "application/json" },
    })
      .then((response) => response.json())
  ...
  const handleLogoUpload = async (file) => {
    ...
    try {
      ...
      const response = await window.authenticatedFetch("/api/upload-logo", {
        method: "POST",
        body: formData,
      });
  ...
  const handleLogoDelete = async (shopId) => {
    ...
    try {
      ...
      const response = await window.authenticatedFetch("/api/remove-logo", {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
  ...
  const handleSignatureUpload = async (file) => {
    ...
    try {
      ...
      const response = await window.authenticatedFetch("/api/upload-signature", {
        method: "POST",
        body: formData,
      });
  ...
  const handleSignatureDelete = async (shopId) => {
    ...
    try {
      ...
      const response = await window.authenticatedFetch("/api/remove-signature", {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ shopId }), // Sending the image URL to delete
      });
  ...
  const updateCheckTaxIncluded = async (shopId, taxIncludedRequest) => {
    try {
      ...
      const response = await window.authenticatedFetch(`/api/update-tax-included?storeDomain=${storeDomain}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          shopId,
